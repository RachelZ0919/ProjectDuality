...
namespace DTT.Utils.EditorUtilities
{
    ...
    public static class AssetUtility
    {
        ...
        /// </summary>
        /// <param name="assetPath">The asset guid.</param>
        /// <param name="preprocessName">The preprocess name. (e.g. UNITY_EDITOR)</param>
        ...
        /// <summary>
        /// Returns the modifiable serialized string property of a text asset.
        /// </summary>
        /// <param name="textAsset">The text asset to get the serialized property for.</param>
        /// <returns>The modifiable serialized string property.</returns>
        public static SerializedProperty GetSerializedProperty(this TextAsset textAsset)
        {
            if (textAsset == null)
                throw new ArgumentNullException(nameof(textAsset));

            return new SerializedObject(textAsset).FindProperty("m_Script");
        }
    }
}
